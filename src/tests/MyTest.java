...
class MyTestDriver extends TestDriver implements GlobalConst {
	...
	/**
	 * MyTestDriver Constructor, inherited from TestDriver
	 */
	public MyTestDriver () {
		super("buftest");
	}
...
//		}
	...
	protected boolean test4 () {
        ...
        System.out.print("\n Test 4..." );
        System.out.print("\n Name of the database is " + Minibase.DiskManager.db_name() );
        System.out.print("\n Page Size " + Minibase.DiskManager.db_page_size() );
        System.out.print("\n Num Pages " + Minibase.DiskManager.db_num_pages() );
        ...
        try {
            for( int i = 0; i < 5; i++ )
            {
                ...
                System.out.println( "\npid after constructing [" + pid.pid + "]" );

                /*
                // allocate one page:
                Minibase.DiskManager.allocate_page(pid);
                System.out.println( "\npid after calling allocate_page [" + pid.pid + "]" );
                */
                ...
                if( pg.getpage() == null )
                {
                    System.out.print( "\nEmpty page object - needs allocation!" );
                }
                else
                {
                    System.out.print( "\nPage is allocated!!" );
                ...
                // write something to the newly created Page object:
                System.out.println( "\npid before initializing to data [" + pid.pid + "]" );
			    int data = pid.pid + 99999;
                ...
                Page pg2 = new Page();
                Minibase.DiskManager.read_page(pid, pg2);

			    data = Convert.getIntValue (0, pg2.getpage());

                System.out.print( "\n data from page is [" + data + "] \n" );
            }
        } 
		catch (Exception e)  { 
			e.printStackTrace();
...
public class MyTest {
	...
	public static void main (String argv[]) {
		...
		MyTestDriver bmt = new MyTestDriver();
		boolean dbstatus;
